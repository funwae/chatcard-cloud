...
import { z } from 'zod';
import { RegisterProofSchema, CreateProposalSchema, CreateItemSchema, UpdateItemSchema, } from '../schemas.js';
...
// Proof schemas
const ProofResourceSchema = registry.register('ProofResource', z.object({
    url: z.string().url(),
    hash: z.string(),
    content_type: z.string(),
    canonicalization: z.enum(['cc-bytes', 'cc-html-1', 'cc-pdf-1', 'cc-md-1']),
}));
const ProofClaimSchema = registry.register('ProofClaim', z.object({
    owner: z.string(),
...
const ProofSignatureSchema = registry.register('ProofSignature', z.object({
    alg: z.literal('Ed25519'),
    public_key: z.string(),
    signature: z.string(),
    signed_at: z.string().datetime(),
}));
const ProofAnchorSchema = registry.register('ProofAnchor', z.object({
    chain: z.string().optional(),
    txid: z.string().optional(),
    at: z.string().datetime().optional(),
}));
const ProofDocumentSchema = registry.register('ProofDocument', z.object({
...
const RegisterProofRequestSchema = registry.register('RegisterProofRequest', RegisterProofSchema);
const RegisterProofResponseSchema = registry.register('RegisterProofResponse', z.object({
    multihash: z.string(),
    url: z.string(),
}));
// Proposal schemas
const ProposalSchema = registry.register('Proposal', z.object({
    id: z.string(),
    title: z.string(),
...
const CreateProposalRequestSchema = registry.register('CreateProposalRequest', CreateProposalSchema);
// Item schemas
const CardItemSchema = registry.register('CardItem', z.object({
    id: z.string(),
    userId: z.string(),
    section: z.enum(['CREATIONS', 'COLLABS', 'INSPIRED', 'CAPABILITIES', 'LINKS']),
    title: z.string(),
...
const CreateItemRequestSchema = registry.register('CreateItemRequest', CreateItemSchema);
const UpdateItemRequestSchema = registry.register('UpdateItemRequest', UpdateItemSchema);
// Card manifest schema
const CardManifestSchema = registry.register('CardManifest', z.object({
    version: z.string(),
    card: z.object({
        handle: z.string(),
        did: z.string(),
